      ...
      <?php
          if (isset($_GET['url'])) {
               if (
                  ...
                  $_GET['url'] == "medidas" ||
                  $_GET['url'] == "clientes" ||
                  $_GET['url'] == "proovedores" ||
                  $_GET['url'] == "administrar.ventas" ||
                  $_GET['url'] == "administrar.compras" ||
                  $_GET['url'] == "administrar.pedidos" ||
                  $_GET['url'] == "compras" ||
                  $_GET['url'] == "venta" ||
                  $_GET['url'] == "compra" ||
                  $_GET['url'] == "empresa" ||
                  $_GET['url'] == "productosminimo" ||
                  $_GET['url'] == "administrar.aperturas" ||
                  $_GET['url'] == "perfil" ||
                  $_GET['url'] == "salida"
               ) {
                  include "vistas/paginas/" . $_GET['url'] . ".php";
               } else {
...
<body>
   <?php include "vistas/paginas/login.php"; ?>
</body>
<?php endif; ?>
